...
try {
  ...
  $a6Checklist = Get-SmokeText -BaseUrl $baseUrl -Path "patient360-a6-checklist.js"
  $s2Prototype = Get-SmokeText -BaseUrl $baseUrl -Path "patient360-s2-prototype.js"
  ...
  Assert-True ($demo.Contains("patient360-a6-checklist.js")) "demo.html should load A6 checklist model"
  Assert-True ($demo.Contains("patient360-s2-prototype.js")) "demo.html should load S2 prototype model"
  ...
  Assert-True ($a6Checklist.Contains("Patient360A6Checklist")) "patient360-a6-checklist.js should expose Patient360A6Checklist"
  Assert-True ($a6Checklist.Contains("projectVisitChecklist")) "patient360-a6-checklist.js should expose visit checklist projection"
  Assert-True ($s2Prototype.Contains("Patient360S2Prototype")) "patient360-s2-prototype.js should expose Patient360S2Prototype"
  Assert-True ($s2Prototype.Contains("buildS2PrototypeBundle")) "patient360-s2-prototype.js should expose S2 prototype bundle builder"
  Assert-True ($preVisitModel.Contains("Ten widok")) "pre-visit model should keep safety copy"
  Assert-True ($caregiverModel.Contains("aktualnym zakresie")) "caregiver model should keep scoped-access safety copy"
  ...
  Assert-True ($app.Contains("renderS2Prototype") -and $app.Contains("data-s2-prototype")) "app.js should contain S2 clickable prototype"
  Assert-True ($app.Contains("a6-checklist-panel")) "app.js should contain A6 visit checklist view"
