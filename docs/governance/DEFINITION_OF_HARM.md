...
| H-006 | AI wygenerowało fakt bez źródła | AI/LLM/OCR runtime = no-go według `PRODUCT_SSOT.md` i `docs/product/PACJENT360_FOUNDER_CONTROL_PACK_V1_2026-07-10.md`; każda zmiana wymaga osobnej decyzji Foundera i aktualizacji current scope | `docs/governance/SAFETY_GATE_MATRIX.md`, aktywny work order i właściwe walidatory; historyczne `docs/SSOT.md`/`docs/SPRINTS.md` niczego nie odblokowują | aktywne (przez no-go) |
