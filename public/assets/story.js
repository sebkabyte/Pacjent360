...
const enCopy = {
  ...
  careCircleBody1: "Patient360 assumes that the story is often organized by the patient, a parent, a legal caregiver or a supporting person. The consent system should show who sees which data, why and until when.",
  ...
  careCircleCard3Text: "A supporting person can help keep the medication list or visit documents in order, but the system does not change treatment or issue medical recommendations.",
  ...
  careCircleNote: "Each consent scope should be revocable, clear to the patient and recorded in the audit trail. This is a product feature for validation in later stages, not legal advice.",
