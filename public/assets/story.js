...
const enCopy = {
  ...
  aiPromiseTitle: "AI assistants that organize documents",
  aiPromiseBody: "The next step is a set of assistants that help prepare materials before the visit. Every output is a draft to review, not a medical decision.",
  aiAssistantDocsTitle: "Document assistant",
  aiAssistantDocsText: "arranges discharge notes, results and attachments into chronology.",
  aiAssistantMedsTitle: "Medication assistant",
  aiAssistantMedsText: "compares medications in documents with what the patient actually takes.",
  aiAssistantVisitTitle: "Visit assistant",
  ...
  careCircleEyebrow: "Care circle and consents",
  careCircleTitle: "A patient does not get sick alone.",
  careCircleBody1: "Patient360 assumes that the story is often organized by the patient, a parent, a legal caregiver or a supporting person. The consent system shows who sees which data, why and until when.",
  careCircleBody2: "A caregiver observation remains an observation, while a clinical fact needs a source and a doctor's assessment. This is especially important for older adults, children, chronic conditions and visits prepared by several people.",
  careCircleDemo: "See caregiver view",
  careCircleCard1Kicker: "Broad scope",
  careCircleCard1Title: "Parent or legal caregiver",
  careCircleCard1Text: "Access comes from the relationship and the authority basis. The system still shows scope, purpose and an audit trail.",
  careCircleCard2Kicker: "Topic-based access",
  careCircleCard2Title: "Only a selected area of history",
  careCircleCard2Text: "A close person can receive documents from a cardiology follow-up without automatically seeing the rest of the history.",
  careCircleCard3Kicker: "Logistical access",
  careCircleCard3Title: "Medications, tasks and visit documents",
  careCircleCard3Text: "A supporting person helps keep the medication list or visit documents in order, but the system does not change treatment or issue medical recommendations.",
  careCircleAllowed: "yes",
  careCircleBlocked: "no",
  careCircleScopeDocs: "documents",
  careCircleScopeMeds: "medications",
  careCircleScopeVisits: "visits",
  careCircleScopeResults: "results",
  careCircleScopeAll: "full history",
  careCircleScopeTasks: "tasks",
  careCircleScopeEdit: "treatment changes",
  careCircleNote: "In the Patient360 model, each consent scope is revocable, clear to the patient and recorded in the audit trail. This is a product feature for validation in later stages, not legal advice.",
  mapEyebrow: "Product vision",
  mapTitle: "Layered map of patient context.",
  mapBody: "The public demo shows patient context as a simple vertical timeline. Patient360 develops a layered map where visits, medications, results and observations meet at the most important moments.",
  mapEvents: "Visits",
  ...
  ctaTitle: "See the demo and help us build a credible patient-context layer.",
  ctaBody: "We start with one thing done well: an organized patient history before the visit. We are looking for doctors, patients, caregivers and partners who want to test it with us.",
  ctaDemo: "Open demo",
